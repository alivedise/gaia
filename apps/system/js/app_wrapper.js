...
(function(window) {
  ...
  window.AppWrapper = function AppError(app) {
    var self = this;
    this.app = app;
  ...
  AppWraper.prototype.view = function view(first_argument) {
  ...
  AppWraper.prototype.render = function render() {
  ...
  AppWraper.prototype.toggleButtonBar = toggleButtonBar(time) {
  ...
  AppWraper.prototype.clearButtonBarTimeout = function clearButtonBarTimeout() {
    clearTimeout(buttonBarTimeout);
    buttonBarTimeout = setTimeout(toggleButtonBar, BUTTONBAR_TIMEOUT);
  }

  AppWraper.prototype.onLocationChange = function onLocationChange() {
