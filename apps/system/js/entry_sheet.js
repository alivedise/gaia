 ...
 * It creates a element provided by container, title, innerElement 
 * and finally returns the DOM element itself.
 */
...
var EntrySheet = (function invocation() {
  ...
  EntrySheet.prototype.createFrame = function(frame) {
    var self = this;
    frame.addEventListener('loadend', function() {
      self.throbberElement.hidden = true;
    });

    this.throbberElement.hidden = false;
    this.contentElement.append(frame);
  }
