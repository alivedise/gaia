...
var PermissionManager = (function() {
  ...
  var handlePermissionPrompt = function pm_handlePermissionPrompt(detail) {
    ...
    if (detail.isApp) {
      ...
      // Web content
      str = navigator.mozL10n.get('permission-ask', {
        'permission': detail.permission, 'app': app.origin
      });
    }
  ...
  var rememberLabel = document.getElementById('permission-remember-label');
  ...
  rememberLabel.addEventListener('click', function onLabelClick() {
