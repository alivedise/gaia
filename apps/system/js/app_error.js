(function(window) {
  ...
  window.AppError = function AppError(app) {
    var self = this;
    this.app = app;
    this.app.element.addEventListener('mozbrowsererror', function(evt) {
  ...
  AppError.prototype.render = function() {
    this.app.element.insertAdjacentHTML('beforeend', this.view());
    this.closeButton =
      this.app.element.querySelector('.' + AppError.className + ' .close');
    this.reloadButton =
      this.app.element.querySelector('.' + AppError.className + ' .reload');
    this.titleElement =
      this.app.element.querySelector('.' + AppError.className + ' .title');
    this.messageElement =
      this.app.element.querySelector('.' + AppError.className + ' .message');
    this.element = this.app.element.querySelector('.' + AppError.className);
    var self = this;
  ...
  AppError.prototype.id = function() {
    return AppError.className + '-' + this.app.element.id;
  };
